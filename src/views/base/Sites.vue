            ...
            <CRow>
              <CCol col-sm="12">
                <CInput v-model="SiteName"
                  label="Specialty"
                  placeholder="궁금한 Specialty를 입력해주세요."
                />
              </CCol>
            </CRow>
...
<!--            </CRow>-->
            <CRow>
              <CCol align="right">
                <CButton type="submit" size="sm" color="primary" v-on:click="insertSite"><CIcon name="cil-check-circle"/> 찾기</CButton>
...
<!--          <CCardBody>-->
<!--            &lt;!&ndash; Bootstrap Vue has some problems with Inline forms that's why we use some standard bootstrap classes &ndash;&gt;-->
<!--            <CForm inline>-->
<!--              <CInput-->
<!--                class="mr-2"-->
